...
- **Soporte multipart para "otros"** — permitir que videos "otros" tengan partes (`_p2`, `_p3`), se agrupen, transcriban/recorten por separado y concatenen en un archivo final. Hoy solo se procesan como archivo único.
...
### `limpiar_clases.py`
- **Borrar partes al limpiar** — al limpiar un video multipart, ahora también borra los archivos `_p2`, `_p3`, etc. del `videos_dir`.
